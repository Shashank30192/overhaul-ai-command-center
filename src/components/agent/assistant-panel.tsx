...
import { Sparkles, Send, RotateCcw, Database, TrendingUp, FileText, AlertTriangle, Users, Thermometer } from "lucide-react";
import { cn } from "@/lib/utils";
import { getAssistantResponse, ASSISTANT_SUGGESTIONS } from "@/lib/mock/agent-mock";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0 mx-6 mt-4 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 flex items-start gap-3">
        ...
        <div className="text-xs text-blue-200">
          <span className="font-semibold">Mode 2 — Generative AI Assistant:</span>{" "}
          Connected to live dashboard context. Generates insights, summaries and recommendations from your platform data. No autonomous actions.
        </div>
      </div>
      ...
      <div className="shrink-0 px-6 pb-6 pt-3 border-t border-[var(--mil-border)]">
        <div className="flex gap-2">
          <input
            ...
            placeholder="Ask about your platform data — risks, trends, carriers, alerts…"
            disabled={isTyping}
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-500 transition-colors disabled:opacity-40 flex items-center gap-2"
          >
        ...
        <p className="text-[10px] text-[var(--mil-muted)] mt-2">
          RiskGPT Assistant reads your live platform data but does not take autonomous actions.
        </p>
      </div>
    </div>
  );
