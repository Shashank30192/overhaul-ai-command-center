...
const AGENT_WORKFORCE = [
  ...
  },
  {
    ...
    accent: "teal",
    desc: "Drag a carrier onto Sherlock and he runs a 3-stage onboarding: discovers your TMS/ERP/EDI stack, generates fraud rules, walks a sample rebind, and deploys — conversationally.",
