...
const APPS = [
  ...
  },
  {
    ...
    desc: "Carrier risk dashboard with Sherlock, the FraudWatch AI specialist — drag a carrier in and he runs a 6-stage onboarding that deploys fraud rules automatically.",
    href: "/fraud-watch",
    color: "#00c2b2",
    bg: "bg-[#00c2b2]/10",
