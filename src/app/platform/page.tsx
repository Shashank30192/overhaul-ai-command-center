...
import {
  Brain, ShieldAlert, Eye, Map, BarChart3, Thermometer, Route, FileText,
...
const APPS = [
  ...
  },
  {
    icon: ShieldAlert,
    title: "Risk Monitor",
    tagline: "Predictive theft & security intelligence",
    desc: "Real-time risk scoring, route heatmaps, and automated security recommendations for every shipment.",
    href: "/risk",
    color: "#ef4444",
    bg: "bg-red-500/10",
  ...
  },
  {
    icon: Eye,
    title: "Fraud Watch",
    tagline: "Carrier fraud & double-brokering detection",
    desc: "Detect fake PODs, MC number mismatches, invoice fraud, and double-brokering patterns in real time.",
    href: "/fraud-watch",
    color: "#f59e0b",
    bg: "bg-amber-500/10",
  ...
  },
  {
    icon: Activity,
    title: "Control Tower",
    tagline: "End-to-end shipment operations hub",
    desc: "Live shipment grid, SLA tracking, AI command center, API monitor, and workflow automation in one place.",
    href: "/control-tower",
    color: "#3b82f6",
    bg: "bg-blue-500/10",
  ...
  },
  {
    icon: Cpu,
    title: "ACE",
    tagline: "Autonomous customer experience engine",
    desc: "AI-powered self-service portal for shipment inquiries, exceptions, and carrier communications.",
    href: "/self-service",
    color: "#06b6d4",
    bg: "bg-cyan-500/10",
